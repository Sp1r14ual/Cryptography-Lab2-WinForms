    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //проверка на соответствие текста алфавиту
                foreach (string s in sequence)
                {
                    string? result = alphabet.FirstOrDefault(x => x == s);
                    if (result == null || s.Length > 1)
                        throw new Exception("Текст не соответствует алфавиту");
                }
            ...
            MessageBox.Show("Закодированная последовательность сохранена в файл output.txt", "Уведомление",
